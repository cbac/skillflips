...
(function($, ko, data){
	...
	skills: [
		{
			id: 1
			, title: 'Algorithmique : bases'
			, description: 'Les bases de l&#39;algoritmique : s&eacute;quence, alternative, it&eacute;rative.'
			, rankDescriptions: [
				'Vous comprenez comment &eacute;crire un algorithme simple.'
			]
            , links: [
                {
                    label: 'Cours sur les bases de l&#39;algorithmique'
                    , url: 'http://moodle.tem-tsp.eu/course/view.php?id=64'
                }
                , {
                    label: 'Qcm sur les bases de l&#39;algorithmique'
	                , url: 'http://moodle.tem-tsp.eu/course/view.php?id=64'
                } , {
                    label: 'Exercices les bases de l&#39;algorithmique'
	                , url: 'http://moodle.tem-tsp.eu/course/view.php?id=64'
				}
            ]
			, maxPoints: 2
		...
		{
			id: 2
			, title: 'Python : variable, valeurs et instructions'
            , links: [
                {
                    label: 'Python'
	                , url: ''
            ...
            , rankDescriptions: [
                'Vous serez capable de lire et d&#39;&eacute;crire des lignes de code python'
            ]
            , description: 'Cette partie explicite syntaxe de base du langage python, ainsi que la d&eacute;claration des variables.'
			, talents: ['Python0']
		},
		{
			id: 3
